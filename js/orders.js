const orders = [ {id: 2340, customer: 101, product: 20, timestamp: "1591243565", price: "12.00"},
...
let test = orders.map(time => { time = new Date(time.timestamp*1000)  
});
